...
<x-admin-layout title="Edit Role User">
    ...
    <div class="py-4 px-8">
        ...
        <div class="px-6 py-2 bg-gray-100 rounded-b-xl">
            ...
            <h3 class="text-lg font-semibold mb-4 text-center">Role User Saat Ini</h3>
            ...
            <form action="{{ route('client-role.store', $user) }}" method="POST" class="space-y-8">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-7">
                    ...
                    {{-- CLIENT --}}
                    <div>
                        <label class="block font-semibold mb-2 text-gray-700">Pilih Client</label>
                        <select name="client_id"
                    ...
                    {{-- ROLE --}}
                    <div>
                        <label class="block font-semibold mb-2 text-gray-700">Pilih Role</label>
                        <select name="role_id"
                            class="w-full px-4 py-3 rounded-xl border focus:ring-blue-500 focus:border-blue-500"
                            required>
                            <option value="">-- pilih role --</option>
                ...
                <div class="flex justify-end pb-4 pt-20">
                    <button class="bg-teal-500 hover:bg-teal-600 text-white px-10 py-3 rounded-xl font-semibold">
                        Simpan
                    </button>
                </div>
