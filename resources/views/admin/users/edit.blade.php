            ...
            <div class="flex items-center gap-4 px-8 py-6">
                <div>
                    <svg width="68" height="68" viewBox="0 0 68 68" fill="none"
                        ...
                        <path
                            d="M34 10C27.376 10 22 15.376 22 22C22 28.624 27.376 34 34 34C40.624 34 46 28.624 46 22C46 15.376 40.624 10 34 10ZM39.208 20.824L32.728 27.304C32.488 27.544 31.984 27.784 31.648 27.856L29.176 28.192C28.264 28.312 27.64 27.688 27.784 26.8L28.144 24.328C28.192 23.992 28.432 23.488 28.696 23.248L35.176 16.768C36.28 15.664 37.6 15.136 39.232 16.768C40.84 18.424 40.312 19.72 39.208 20.824Z"
                            fill="#FDFDFD" />
                        <path
            ...
            <div class="mb-8 bg-blue-50 border-l-8 border-blue-500 rounded-lg p-4">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm">Pastikan semua data yang dimasukkan sudah benar dan valid.
                            Perubahan data akan langsung diterapkan di sistem SSO</p>
                    </div>
                </div>
            </div>
                ...
                <div>
                    ...
                    <div class="relative w-full md:w-1/2">
                        ...
                        <button type="button"
                            ...
                            <svg id="eye-off-icon-password" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 hidden"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
