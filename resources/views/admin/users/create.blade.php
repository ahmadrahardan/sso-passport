            ...
            <div class="flex items-center gap-4 px-8 py-6">
                <div>
                    <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M42.904 13.984C40.744 11.536 37.528 10 34 10C30.64 10 27.568 11.368 25.384 13.624C23.296 15.784 22 18.76 22 22C22 24.256 22.624 26.368 23.752 28.168C24.352 29.2 25.12 30.136 26.032 30.904C28.12 32.824 30.904 34 34 34C38.392 34 42.184 31.648 44.272 28.168C44.896 27.136 45.376 25.984 45.64 24.784C45.88 23.896 46 22.96 46 22C46 18.928 44.824 16.12 42.904 13.984ZM38.488 24.208H36.256V26.536C36.256 27.784 35.248 28.792 34 28.792C32.752 28.792 31.744 27.784 31.744 26.536V24.208H29.512C28.264 24.208 27.256 23.2 27.256 21.952C27.256 20.704 28.264 19.696 29.512 19.696H31.744V17.56C31.744 16.312 32.752 15.304 34 15.304C35.248 15.304 36.256 16.312 36.256 17.56V19.696H38.488C39.736 19.696 40.744 20.704 40.744 21.952C40.744 23.2 39.736 24.208 38.488 24.208Z" fill="#FDFDFD"/>
                    </svg>
                </div>
                <div>
            ...
            <div class="mb-8 bg-blue-50 border-l-8 border-blue-500 rounded-lg p-4">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm">Pastikan semua data yang dimasukkan sudah benar dan valid. Akun yang sudah dibuat akan langsung aktif di sistem SSO</p>
                    </div>
                </div>
            </div>
