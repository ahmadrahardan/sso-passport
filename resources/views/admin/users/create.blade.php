<x-admin-layout title="Tambah User Baru">
    ...
    <div class="px-10 py-5 mx-auto min-w-0 w-fit ml-0">
        <a href="{{ route('users.index') }}"
            class="flex items-center gap-2 text-black hover:text-[#3a3a3a] transition-colors group">
    ...
    <div class="px-10 mx-auto min-w-0 h-full">
            ...
            <div class="flex items-center gap-4 px-8 py-6">
                <div>
                    <svg width="68" height="68" viewBox="0 0 68 68" fill="none"
                        ...
                        <path
                            d="M34 39C21.8746 39 12 46.98 12 56.8125C12 57.4775 12.5325 58 13.2101 58H54.7899C55.4675 58 56 57.4775 56 56.8125C56 46.98 46.1254 39 34 39Z"
                            fill="#FDFDFD" />
                        <path
                            d="M42.904 13.984C40.744 11.536 37.528 10 34 10C30.64 10 27.568 11.368 25.384 13.624C23.296 15.784 22 18.76 22 22C22 24.256 22.624 26.368 23.752 28.168C24.352 29.2 25.12 30.136 26.032 30.904C28.12 32.824 30.904 34 34 34C38.392 34 42.184 31.648 44.272 28.168C44.896 27.136 45.376 25.984 45.64 24.784C45.88 23.896 46 22.96 46 22C46 18.928 44.824 16.12 42.904 13.984ZM38.488 24.208H36.256V26.536C36.256 27.784 35.248 28.792 34 28.792C32.752 28.792 31.744 27.784 31.744 26.536V24.208H29.512C28.264 24.208 27.256 23.2 27.256 21.952C27.256 20.704 28.264 19.696 29.512 19.696H31.744V17.56C31.744 16.312 32.752 15.304 34 15.304C35.248 15.304 36.256 16.312 36.256 17.56V19.696H38.488C39.736 19.696 40.744 20.704 40.744 21.952C40.744 23.2 39.736 24.208 38.488 24.208Z"
                            fill="#FDFDFD" />
                    </svg>
                </div>
                <div>
                    <h1 class="text-white text-2xl font-bold">Form Tambah Data Akun</h1>
            ...
            <div class="mb-8 bg-blue-50 border-l-8 border-blue-500 rounded-lg p-4">
                <div class="flex items-start gap-3">
                    <div>
                        <svg width="51" height="51" viewBox="0 0 51 51" fill="none"
                            ...
                            <g filter="url(#filter0_d_4461_10868)">
                                ...
                                <path
                                    d="M25.5023 10.418C16.0894 10.418 8.41895 18.0884 8.41895 27.5013C8.41895 36.9142 16.0894 44.5846 25.5023 44.5846C34.9152 44.5846 42.5856 36.9142 42.5856 27.5013C42.5856 18.0884 34.9152 10.418 25.5023 10.418ZM24.221 20.668C24.221 19.9676 24.8019 19.3867 25.5023 19.3867C26.2027 19.3867 26.7835 19.9676 26.7835 20.668V29.2096C26.7835 29.9101 26.2027 30.4909 25.5023 30.4909C24.8019 30.4909 24.221 29.9101 24.221 29.2096V20.668ZM27.0739 34.9838C26.9885 35.2059 26.8689 35.3767 26.7152 35.5476C26.5444 35.7013 26.3564 35.8209 26.1514 35.9063C25.9464 35.9917 25.7244 36.043 25.5023 36.043C25.2802 36.043 25.0581 35.9917 24.8531 35.9063C24.6481 35.8209 24.4602 35.7013 24.2894 35.5476C24.1356 35.3767 24.016 35.2059 23.9306 34.9838C23.8452 34.7788 23.7939 34.5567 23.7939 34.3346C23.7939 34.1126 23.8452 33.8905 23.9306 33.6855C24.016 33.4805 24.1356 33.2926 24.2894 33.1217C24.4602 32.968 24.6481 32.8484 24.8531 32.763C25.2631 32.5921 25.7414 32.5921 26.1514 32.763C26.3564 32.8484 26.5444 32.968 26.7152 33.1217C26.8689 33.2926 26.9885 33.4805 27.0739 33.6855C27.1594 33.8905 27.2106 34.1126 27.2106 34.3346C27.2106 34.5567 27.1594 34.7788 27.0739 34.9838Z"
                                    fill="#046CE2" />
                            </g>
                            <defs>
                                <filter id="filter0_d_4461_10868" x="0" y="0" width="51" height="51"
                                    ...
                                    <feBlend mode="normal" in2="BackgroundImageFix"
                                        result="effect1_dropShadow_4461_10868" />
                                    <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_4461_10868"
                                        result="shape" />
                                </filter>
                            </defs>
                        </svg>
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm">Pastikan semua data yang dimasukkan sudah benar dan valid. Akun
                            yang sudah dibuat akan langsung aktif di sistem SSO</p>
                    </div>
                </div>
            </div>

            <div id="form-container">
                <form action="{{ route('users.store') }}" method="POST" id="createUserForm" class="space-y-8"
                    ...
                    <div>
                        ...
                        @error('password')
                            <p class="text-red-600 text-sm mt-2 flex items-center gap-1">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                    class="w-4 h-4">
                                    <path d="M12 22C6.47715 22 2 17.5228 2 12
