<div class="w-full flex flex-col h-full max-w-md mx-auto">
    <div class="flex-1 flex flex-col items-center justify-center space-y-6">
        ...
        <div class="text-center">
            <h2 class="text-2xl font-bold text-white mb-2">Super Admin</h2>
            ...
            <div class="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 hover:bg-white/10 transition-all duration-300">
                <div class="flex items-start space-x-3">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-white text-sm font-medium truncate">superadmin@gmail.com</p>
                    </div>
                </div>
            </div>
    ...
    <div class="mt-8 text-center">
        <a href="{{ route('login') }}"
        class="inline-block bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-semibold py-3 px-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
            Logout
        </a>
    </div>
</div>
