    ...
    <div class="max-w-7xl mx-auto">
        ...
        @if (session('status') === 'profile-updated')
            <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 3000)"
                class="fixed top-24 right-6 bg-emerald-500 text-white px-6 py-3 rounded-xl shadow-lg flex items-center gap-3 z-50">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 rounded-t-2xl shadow-lg">
            <div class="flex items-center gap-4 px-8 py-6">
                ...
                <div>
                    <h1 class="text-white text-2xl font-bold">Edit Profil</h1>
            ...
            <div class="mb-8 bg-blue-50 border-l-8 border-blue-500 rounded-lg p-4">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 text-sm">Pastikan semua data yang dimasukkan sudah benar dan valid. Data yang sudah disimpan akan masuk ke sistem.</p>
                    </div>
                </div>
            </div>
            ...
            <form method="post" action="{{ route('profile.update') }}" class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-xs mt-2">Email tidak dapat diubah</p>
                    </div>

                    {{-- Password Baru --}}
                    <div>
                        <label class="block text-gray-700 font-medium mb-2">
                            Password Baru <span class="text-gray-500 text-sm font-normal">(Opsional)</span>
                        </label>
                        <div class="relative">
                            <input
                                type="password"
                        ...
                        @enderror
                        <p class="text-gray-500 text-xs mt-2">Kosongkan jika tidak ingin mengubah password</p>
                    </div>

                    {{-- Konfirmasi Password --}}
                    <div>
                        <label class="block text-gray-700 font-medium mb-2">
                            Konfirmasi Password <span class="text-gray-500 text-sm font-normal">(Opsional)</span>
                        </label>
                        <div class="relative">
                            <input
                                type="password"
                            ...
                            <button
                                type="button"
                                onclick="togglePassword('password_confirmation', 'eye-icon-confirmation', 'eye-off-icon-confirmation')"
                                class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700">
                                <svg id="eye-icon-confirmation" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                </svg>
                                <svg id="eye-off-icon-confirmation" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L6.59 6.59m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" />
                                </svg>
                            </button>
                        </div>
                        <p class="text-gray-500 text-xs mt-2">Ulangi password baru untuk konfirmasi</p>
                    </div>
